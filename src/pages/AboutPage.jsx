    ...
    return (
        <div className="card" id="about-card">
            ...
            <div className="card-body about-content">
                ...
                <p className='about-text'>
                    I am finishing up my last few weeks of the Coding Bootcamp at the University of
                    Texas at Austin. I am hoping to get a job that can lead me into the Artificial Intellegence
                    world so that I can help usher in the age of our A.I. Overlords!
                </p>
            </div>
